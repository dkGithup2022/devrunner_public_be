...
@Component
public class TechBlogCategoryExtractor
        extends AbstractSingleGptRunner<TechBlogCategoryExtractor.TechBlogCategoryResult> {

    protected TechBlogCategoryExtractor(ChatModel chatModel, ObjectMapper objectMapper) {
    ...
    private static final String PROMPT = """
        You are an AI classifier that analyzes techblog postings and assigns relevant technology categories.
